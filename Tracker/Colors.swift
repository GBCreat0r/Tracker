...
//  Tracker
//
//  Created by semrumyantsev on 05.08.2025.
//
...
enum Colors {
    ...
    static var background: UIColor {
        UIColor { traitCollection in
            ...
            #colorLiteral(red: 0.1019607843, green: 0.1058823529, blue: 0.1333333333, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        }
    }
    ...
    static var textPrimary: UIColor {
        UIColor { traitCollection in
            traitCollection.userInterfaceStyle == .dark ?
            #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) : #colorLiteral(red: 0.1019607843, green: 0.1058823529, blue: 0.1333333333, alpha: 1)
        }
    }
    ...
    static var placeholder: UIColor {
        UIColor { traitCollection in
            traitCollection.userInterfaceStyle == .dark ?
            #colorLiteral(red: 0.9215686275, green: 0.9215686275, blue: 0.9607843137, alpha: 1) : #colorLiteral(red: 0.6823529412, green: 0.6862745098, blue: 0.7058823529, alpha: 1)
        }
    }
}
